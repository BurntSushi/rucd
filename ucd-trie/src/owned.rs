...
// These partitions convenient correspond to the space of 1 or 2 byte UTF-8
...
impl TrieSetOwned {
    ...
    /// fit into a trie.
    pub fn from_scalars(scalars: &[char]) -> Result<TrieSetOwned> {
    ...
    pub fn from_codepoints(codepoints: &[u32]) -> Result<TrieSetOwned> {
        let mut all = vec![false; 0x110000];
